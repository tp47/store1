...
class CartItem extends Component {
  render() {
    ...
    return (
      <div
        key={id}
        className="p-2 col-12 d-md-flex  mx-auto font-weight-bolder text-center cart-item my-2"
      >
        ...
        <div className="col-10 col-md-2 my-auto mx-auto mb-1">
          <i
            className="fa fa-minus-square mx-1 fs"
            onClick={() => {
          ...
          <i
            className="fa fa-plus-square mx-1 fs"
            onClick={() => {
        ...
        <div className="col-10 col-md-2 my-auto mx-auto">
          <i
            className="fa fa-trash danger mb-1 mt-1 fs"
            onClick={() => {
